...
Covers only what's new since the v7 pass completed — that pass already ran to completion and its results are the closed historical record in `test_cases_v7.md`; don't append further cases there. This doc will grow as more features land, rather than duplicating everything v7 already tested.
